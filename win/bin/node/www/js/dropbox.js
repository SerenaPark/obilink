...
(function() {
  var Dropbox, DropboxClient, DropboxXhrCanSendForms, DropboxXhrIeMode, DropboxXhrRequest, add32, arrayToBase64, atob, atobNibble, base64Digits, base64HmacSha1, base64Sha1, btoa, btoaNibble, crypto, dropboxEncodeKey, hmacSha1, rotateLeft32, sha1, stringToArray, _base64Digits,
  ...
  Dropbox.Client = (function() {
    ...
    Client.prototype.readFile = function(path, options, callback) {
      ...
      xhr.setParams(params).addOauthParams(this.oauth).setResponseType(responseType);
    ...
    Client.prototype.writeFileUsingForm = function(path, data, options, callback) {
      ...
      xhr.setParams(params).addOauthParams(this.oauth).setFileField('file', fileName, data, 'application/octet-stream');
      delete params.file;
    ...
    Client.prototype.writeFileUsingPut = function(path, data, options, callback) {
      ...
      xhr.setBody(data).setParams(params).addOauthParams(this.oauth);
      return this.dispatchXhr(xhr, function(error, metadata) {
        return callback(error, Dropbox.Stat.parse(metadata));
      });
    };
    ...
    Client.prototype.stat = function(path, options, callback) {
      ...
      xhr.setParams(params).addOauthParams(this.oauth);
      return this.dispatchXhr(xhr, function(error, metadata) {
    ...
    Client.prototype.makeUrl = function(path, options, callback) {
      ...
      xhr = new Dropbox.Xhr('POST', url).setParams(params).addOauthParams(this.oauth);
    ...
    Client.prototype.thumbnailXhr = function(path, options) {
      ...
      return xhr.setParams(params).addOauthParams(this.oauth);
    };
    ...
    Client.prototype.requestToken = function(callback) {
      var xhr;
      xhr = new Dropbox.Xhr('POST', this.urls.requestToken).addOauthParams(this.oauth);
    ...
    Client.prototype.getAccessToken = function(callback) {
      var xhr;
      xhr = new Dropbox.Xhr('POST', this.urls.accessToken).addOauthParams(this.oauth);
      return this.dispatchXhr(xhr, callback);
    };
  ...
  */
  ...
  Dropbox.Xhr = (function() {
    ...
    Xhr.prototype.addOauthHeader = function(oauth) {
      ...
      this.params || (this.params = {});
      this.headers['Authorization'] = oauth.authHeader(this.method, this.url, this.params);
      this.signed = true;
      return this;
    };
    ...
    Xhr.prototype.setAuthHeader = function(authHeader) {
      return this.headers['Authorization'] = authHeader;
    };
    ...
    Xhr.prototype.setFileField = function(fieldName, fileName, fileData, contentType) {
      ...
      useFormData = (typeof fileData === 'object') && (((typeof Blob !== "undefined" && Blob !== null) && (fileData instanceof Blob)) || ((typeof File !== "undefined" && File !== null) && (fileData instanceof File)));
      if (useFormData) {
